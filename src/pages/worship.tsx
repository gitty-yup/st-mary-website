        ...
        <div className='max-w-4xl mx-auto'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
            {[
              ...
              { q: 'Where do I park?', a: 'Ample parking is available on-site and along surrounding streets. Curbside loading and unloading are permissible in front of the sanctuary but parking there is strictly prohibited.' },
              ...
              { q: 'Is the service in Armenian?', a: 'Badarak is celebrated in Classical Armenian (Grabar) with English and Modern Armenian translations. Sermons are bilingual, allowing full participation no matter your comfort with Armenian.' },
