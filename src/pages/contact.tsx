...
export default function Contact() {
  return (
    <AppLayout>
      <header className='contact-bg px-primary h-[205px] md:h-[305px] flex flex-col items-center justify-center text-center gap-3 text-white'>
            ...
            <div>
              ...
              <div className='mt-8'>
                ...
                <div className='flex gap-4'>
                  ...
                  <a
                    href='https://www.instagram.com/stmaryarmenianchurch/'
                    target='_blank'
                    rel='noreferrer'
                    className='bg-[#E4405F] text-white px-4 py-2 rounded-lg text-sm font-medium hover:brightness-90 transition'
                  >
                    Instagram
                  </a>
                </div>
              ...
              <div className='mt-8 rounded-2xl overflow-hidden'>
                <iframe
                  src='https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3313.0!2d-117.9028!3d33.6492!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80dcde3a5a5a5a5a%3A0x1!2s148+E+22nd+St%2C+Costa+Mesa%2C+CA+92627!5e0!3m2!1sen!2sus!4v1'
                  width='100%'
                  height='250'
                  style={{ border: 0 }}
                  allowFullScreen
