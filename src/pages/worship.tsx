        ...
        <div className='max-w-4xl mx-auto'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
            {[
              ...
              { q: 'Where do I park?', a: 'Ample parking is available on-site and on surrounding streets. Curbside loading and unloading is permitted in front of the sanctuary, but parking there is strictly prohibited.' },
